...
<div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body table-responsive">
              <table  class="table" id="newsletterTable" data-url="{{ route('admin.newsletter.list') }}" style="width: 100%;">
                <thead class="thead-dark">
                <tr>
                                <th style="width:1%">No</th>
                                <th style="width:25%" data-orderable="true">Date</th>
                                <th style="width:5%"  data-orderable="true" >Email</th>
                </tr>
                </thead>
                <tbody>
...
<script src="{{ asset('assets/admin/js/newsletter/newsletter-datatable.js') }}"></script>
