...
<head>
    ...
    <link rel="stylesheet" href="{{asset('websiteview/assets/css/card-design1.css') }}">
    <script type='text/javascript'
            src='https://platform-api.sharethis.com/js/sharethis.js#property=5e0eea7fe13da80012ea3471&product=inline-share-buttons&cms=website'
            async='async'></script>
    ...
    <div class="d-flex justify-content-center row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-4">
            <div class="card shadow-lg p-3 mb-5 bg-white rounded" style="width: 25rem;">
                ...
                <img style="height: 200px;width: 50%;margin: auto;" class="card-img-top"
                ...
                <div class="card-body">
                    <a href="{{url('/')}}" class="card-link"><span style="color: #000000;">Created In </span> City Post</a>
